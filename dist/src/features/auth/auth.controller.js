...
var register = function (httpRequest) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name, user, registerResult, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = httpRequest.body, email = _a.email, password = _a.password, name = _a.name;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, doCheckUserExist(email)];
            case 2:
                ...
                return [4 /*yield*/, doRegister({ email: email, password: password, name: name })];
            case 3:

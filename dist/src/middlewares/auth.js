    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!token) {
                    next(new utils_1.ErrorHandler("Unathorized", utils_1.HTTP_STATUS_CODES.UNOOTHORIZD));
                }
                token = token.replace("Bearer ", "");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, utils_1.verifyJWT)({
                        token: token,
            ...
            case 2:
                payload = _a.sent();
                req.user = payload;
                req = __assign(__assign({}, req), { user: payload });
                return [2 /*return*/, next()];
            case 3:
                err_1 = _a.sent();
                next(new utils_1.ErrorHandler("Session Timeout", utils_1.HTTP_STATUS_CODES.UNOOTHORIZD));
                return [3 /*break*/, 4];
